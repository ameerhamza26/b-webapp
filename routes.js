...
module.exports = function (app) {
    ...
    app.post('/events/remove/:id',events.delete);
    ...
    app.post('/talkingpoints/remove/:id', talkingPoints.delete);
    ...
    app.post('/resources/remove/:id', resources.delete);
    ...
    app.post('/survey/remove/:id', survey.delete);
