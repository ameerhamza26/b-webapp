...
CREATE TABLE `SurveyQuestions` (
  ...
  `Option1` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `Option2` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `Option3` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `Option4` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
